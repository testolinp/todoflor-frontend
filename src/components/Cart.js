...
const Cart = ({showCart, handlerHideCart}) => {
  return (
    <section className={showCart ? 'cart cart--show' : 'cart'}>
      <div className="cart__wrapper">
        <div className="cart__content">
          <div className="cart__content__top">
            <a href="#" className="cart__content__close" onClick={handlerHideCart}><img src="/images/close.svg" /></a>
            ...
            <div className="cart__content__box">
              ...
              <div className="cart__content__box__data">
                ...
                <div className="cart__content__box__data__ft">
                  <div className="cart__content__box__data__ft__quantity">
